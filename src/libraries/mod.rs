...
pub use resolve::{
    Entry, PATH_SEPARATOR, VOEBB_NETWORK, alias_for, branch_location, by_isil, by_kobvid,
    by_portal_name, display_name, find, institution_location, look_up, name_holding, near, resolve,
    short_name_for, suggest,
};
